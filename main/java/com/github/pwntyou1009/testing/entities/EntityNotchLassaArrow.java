package com.github.pwntyou1009.testing.entities;
...
public class EntityNotchLassaArrow extends EntityArrow implements IProjectile
{
    ...
    public EntityNotchLassaArrow(World p_i1753_1_)
    {
        super(p_i1753_1_);
    ...
    public EntityNotchLassaArrow(World p_i1754_1_, double p_i1754_2_, double p_i1754_4_, double p_i1754_6_)
    {
        super(p_i1754_1_);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityNotchLassaArrow(World p_i1755_1_, EntityLivingBase p_i1755_2_, EntityLivingBase p_i1755_3_, float p_i1755_4_, float p_i1755_5_)
    {
        super(p_i1755_1_);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityNotchLassaArrow(World p_i1756_1_, EntityLivingBase p_i1756_2_, float p_i1756_3_)
    {
        super(p_i1756_1_);
        this.renderDistanceWeight = 10.0D;
            ...
            if (movingobjectposition != null)
            {
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    if (movingobjectposition.entityHit instanceof EntityZombie
                        	|| movingobjectposition.entityHit instanceof EntitySkeleton
                        	|| movingobjectposition.entityHit instanceof EntityPigZombie
                        	|| movingobjectposition.entityHit instanceof EntityWither)
                    {
                        	k += 3;
                    }
                    ...
                    if (movingobjectposition.entityHit.attackEntityFrom(damagesource, (float)k))
                    {
                        if (movingobjectposition.entityHit instanceof EntityLivingBase)
                        {
                            ...
                            entitylivingbase.addPotionEffect(new PotionEffect(20, Integer.MAX_VALUE, 0));
